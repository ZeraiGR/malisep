...
document.addEventListener("DOMContentLoaded", function () {
  ...
  (function () {
    ...
    if (document.querySelector(".partners__tabs") && t(".partners__tabs"), document.querySelector(".events-main__content") && t(".events-main__content"), document.querySelector(".events__categories-box") && t(".events__categories-box"), document.querySelector(".program")) {
  ...
  }(), document.querySelectorAll(".scroll-link").forEach(function (e) {
    e && e.addEventListener("click", function (t) {
      t.preventDefault();
      var n = e.getAttribute("href").replace("#", ""),
          i = document.getElementById(n).offsetTop;
      console.log(i), window.scrollTo({
        top: i,
        behavior: "smooth"
      });
    });
  ...
  (function () {
    var e = document.querySelectorAll(".works-slide__bullets");
    e[0] && (e[0].removeChild(e[0].lastElementChild), e[0].removeChild(e[0].lastElementChild));
  })();
